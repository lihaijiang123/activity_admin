...
-- ----------------------------
BEGIN;
INSERT INTO `act_attention` VALUES (17, 24, 3, '0000-00-00 00:00:00');
INSERT INTO `act_attention` VALUES (25, 24, 1, '0000-00-00 00:00:00');
COMMIT;
...
CREATE TABLE `act_collection` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=72 DEFAULT CHARSET=utf8 COMMENT='收藏表';
...
INSERT INTO `act_collection` VALUES (71, 24, 33, 1593748217);
COMMIT;
...
INSERT INTO `act_join` VALUES (34, 24, 33, 1593748052);
COMMIT;
...
CREATE TABLE `act_share` (
  ...
  `create_time` int(10) DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='分享表';
...
INSERT INTO `act_share` VALUES (39, 24, 33, 1593744773);
INSERT INTO `act_share` VALUES (40, 24, 1, 1593748836);
INSERT INTO `act_share` VALUES (41, 24, 60, 1593748861);
INSERT INTO `act_share` VALUES (42, 24, 61, 1593748873);
COMMIT;
...
) ENGINE=MyISAM AUTO_INCREMENT=650 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='权限节点';
