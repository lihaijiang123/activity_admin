...
CREATE TABLE `act_feedback` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='建议与反馈';
...
-- ----------------------------
BEGIN;
INSERT INTO `act_hot_country` VALUES (1, '100000001', '美国');
INSERT INTO `act_hot_country` VALUES (2, '100000002', '马来西亚');
INSERT INTO `act_hot_country` VALUES (3, '100000003', '印度');
INSERT INTO `act_hot_country` VALUES (4, '100000004', '泰国');
INSERT INTO `act_hot_country` VALUES (5, '100000005', '缅甸');
INSERT INTO `act_hot_country` VALUES (6, '100000006', '巴塞尔');
INSERT INTO `act_hot_country` VALUES (7, '100000007', '罗马');
INSERT INTO `act_hot_country` VALUES (8, '100000008', '悉尼');
INSERT INTO `act_hot_country` VALUES (10, '10000010', '罗马尼西亚啊');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `act_industry` VALUES (1, '工人');
INSERT INTO `act_industry` VALUES (2, '销售');
INSERT INTO `act_industry` VALUES (3, 'SEO');
INSERT INTO `act_industry` VALUES (4, 'UI');
INSERT INTO `act_industry` VALUES (5, 'SEM');
INSERT INTO `act_industry` VALUES (6, 'Ruby');
COMMIT;
...
CREATE TABLE `act_sign` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 COMMENT='报名信息表';
...
) ENGINE=MyISAM AUTO_INCREMENT=653 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='权限节点';
