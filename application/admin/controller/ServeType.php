...
use app\admin\model\ServeType as ServeTypeModel;
use think\facade\Session;

// 模型控制器
class ServeType extends Common{
     ...
     */
    public function Del(){
    	if(ServeTypeModel::destroy(input('id'))){
