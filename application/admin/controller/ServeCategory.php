...
use app\admin\model\ServeCategory as ServeCategoryModel;
use think\facade\Session;

// 模型控制器
class ServeCategory extends Common{
     ...
     */
    public function Del(){
    	if(ServeCategoryModel::destroy(input('id'))){
    ...
    public function add(){
        if(request()->isPost()){
            ...
            $model = new ServeCategoryModel($data);
			// 过滤post数组中的非数据表字段数据
